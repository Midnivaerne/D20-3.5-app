...
public class SettingsActivity extends AppCompatPreferenceActivity {
  ...
  public static class GeneralPreferenceFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      getPreferenceScreen().getPreference(R.id.pref_title_social_recommendations)
          .setSummary(translate("pref_description_social_recommendations"));
      ...
      getPreferenceScreen().getPreference(R.id.pref_title_add_friends_to_messages)
          .setTitle(translate("pref_title_add_friends_to_messages"));
      ((ListPreference) getPreferenceScreen().getPreference(R.id.pref_title_add_friends_to_messages))
          .setEntries(new String[]{translate("pref_example_list_titles")}); //todo set array
      ((ListPreference) getPreferenceScreen().getPreference(R.id.pref_title_add_friends_to_messages))
          .setEntryValues(new String[]{translate("pref_example_list_values")}); //todo set array
  ...
  public static class NotificationPreferenceFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      getPreferenceScreen().getPreference(R.id.pref_title_new_message_notifications)
          .setTitle(translate("pref_title_new_message_notifications"));
  ...
  public static class DataSyncPreferenceFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      ((ListPreference) getPreferenceScreen().getPreference(R.id.pref_title_sync_frequency))
          .setEntries(new String[]{translate("pref_sync_frequency_titles")}); //todo set array
      ((ListPreference) getPreferenceScreen().getPreference(R.id.pref_title_sync_frequency))
          .setEntryValues(new String[]{translate("pref_sync_frequency_values")}); //todo set array
